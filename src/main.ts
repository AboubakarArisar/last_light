...
function pause() {
  ...
  ui.insertAdjacentHTML(
    "beforeend",
    `<div class="modal-backdrop"><section class="modal" role="dialog" aria-modal="true"><div class="eyebrow">TAKE A BREATH</div><h1>HALF<br><em>A MOMENT.</em></h1>${button("resume", t.resume + " ↗", "primary")}${button("retry", "Restart moment", "secondary")}${button("home", "Back to home", "text-button")}</section></div>`,
  );
  sound.suspend();
}
function replayUI() {
